...
def gpt3Turbo_completion(chat_prompt="", system="You are an AI that can give the answer to anything", temp=0.7, model="gpt-4o-mini", max_tokens=32000, remove_nl=True, conversation=None):
